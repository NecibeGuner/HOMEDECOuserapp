...
//ChairFragment sınıfı, BaseCategoryFragment'ten türetilmiş bir sınıftır ve belirli bir
//kategori (burada 'sandalye') için teklifler ve en iyi ürünlerin gösterildiği bir yapı
//sağlar. Açıklamalar, yaşam döngüsü kapsamında ViewModel'den gelen verileri nasıl topladığını,
//bu verileri nasıl işlediğini ve kullanıcı arayüzünde nasıl gösterdiğini anlatır. Teklifler ve
//en iyi ürünler için verilerin yüklenme durumunu, başarı durumunu veya hata durumunu işler ve
//kullanıcıya uygun geribildirimler sağlar.
